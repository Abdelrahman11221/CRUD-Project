...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <nav class="mt-2">
        ...
        <li class="nav-item has-treeview menu-open">
            ...
            <li class="nav-item">
                <a href="{{route('faq_form_data')}}" class="nav-link active">
                <i class="far fa-circle nav-icon"></i>
                <p>FAQs Form</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{route('faq_answer')}}" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>FAQs Answers</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{route('our_contact')}}" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Contact</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{route('std_review')}}" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Reviews</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{route('get_slider')}}" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Slider</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{route('course_form')}}" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Course Form</p>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a href="{{route('teacher_form')}}" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Teacher Form</p>
                </a>
            </li>
