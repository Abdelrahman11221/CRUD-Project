            ...
            <div class="card-tools">
                ...
                <div class="card-body">
                    <div class="card card-info">
                        <div class="card-header">
                        <h3 class="card-title">FAQs Data</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        {{-- {{dd($questions->question)}} --}}
                    <form action="{{route('faq_ans')}}" method="POST">
                        @csrf
                            ...
                            @if($questions)
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Question</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="question" value="{{$questions->question}}" readonly>
                                        </div>
                                </div>
                            @endif
                                <div class="form-group row">
